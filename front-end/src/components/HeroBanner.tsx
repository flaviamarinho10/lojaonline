...
export default function HeroBanner({ settings }: HeroBannerProps) {
    ...
    return (
        <section className="relative w-full bg-gray-50 group overflow-hidden">
            <div className="relative w-full">
                ...
                <img
                    ...
                    alt={settings.title}
                    className="w-full h-auto hidden md:block transition-transform duration-1000 group-hover:scale-105"
                />
                            ...
                            {settings.buttonText && (
                                <div className="pt-4">
                                    <a
                                        ...
                                        className="inline-block bg-white text-gray-900 border-2 border-white px-8 py-3.5 rounded-full font-bold uppercase tracking-widest text-xs md:text-sm hover:bg-transparent hover:text-white transition-all duration-300"
                                    >
                                        {settings.buttonText}
                                    </a>
                                </div>
